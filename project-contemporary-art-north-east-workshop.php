<?php
$page_title = "Value Added: making and presenting content for the web";
$page_extra = "projects";
$page_description = "";
        ...
        <div class="span12">
            <div class="row">
                ...
                <div class="span6">
                    <blockquote>
                        <h5>Quote:</h5>
                        <p>A really useful and very enjoyable event.</p> 
                        <cite><strong>Julia Bell</strong>, National and North East Coordinator, Contemporary Visual Arts Network</cite>
                    </blockquote>
                </div>                
            </div>
        </div>
